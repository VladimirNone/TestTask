...
namespace ForInterview.Migrations
{
    ...
    [Migration("20200825095739_Added_Blog_Post_Evaluation_Models")]
    partial class Added_Blog_Post_Evaluation_Models
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ForInterview.Models.Blog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ForInterview.Models.Evaluation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ForInterview.Models.Post", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("ForInterview.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("ForInterview.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("ForInterview.Models.Blog", b =>
                {
                    b.HasOne("ForInterview.Authorization.Users.User", "Author")
                        .WithMany("Blogs")
            ...
            modelBuilder.Entity("ForInterview.Models.Evaluation", b =>
                {
                    b.HasOne("ForInterview.Authorization.Users.User", "Evaluator")
                        .WithMany("Evaluations")
                        .HasForeignKey("EvaluatorId1");

                    b.HasOne("ForInterview.Models.Post", "Post")
                        .WithMany("Evaluations")
            ...
            modelBuilder.Entity("ForInterview.Models.Post", b =>
                {
                    ...
                    b.HasOne("ForInterview.Models.Blog", "Blog")
                        .WithMany("Posts")
