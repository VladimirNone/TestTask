...
{
    public abstract class ForInterviewWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ForInterviewWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ForInterviewWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ForInterviewDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ForInterviewDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ForInterviewDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ForInterviewDbContext, Task<T>> func)
        {
            T result;
